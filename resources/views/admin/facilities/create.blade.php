...
@section('content')
    ...
    <style>
        ...
        .form-container {
            ...
            padding: 2.5rem;
            border-radius: 16px;
            border: 2px solid #d9a036; /* Warna kuning emas khas proyek kelompokmu */
    ...
    <div class="page-wrapper">
        <div class="form-container">
            <div class="header-title-wrapper">
                ...
                <p style="color: #6b7280; font-size: 0.9rem; margin-top: 5px; font-family: sans-serif;">Silakan isi data fasilitas baru di bawah ini</p>
            ...
            <form action="{{ route('facility-create-submit') }}" method="POST" class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-input" placeholder="Masukkan nama fasilitas" value="{{ old('name') }}" required>
                </div>

                <div class="form-group">
                    <label for="description" class="form-label">Deskripsi Fasilitas</label>
                    <textarea id="description" name="description" class="form-input form-textarea" placeholder="Jelaskan detail singkat mengenai fasilitas ini..." required>{{ old('description') }}</textarea>
                </div>
